...
public class CaptainPageID {
    ...
    public static final String MESSAGE_CAPTAIN_BUTTON = "//*[@class='message-captain-button']";
    public static final String AVAILABLE_DATE = "//td[@class='day' and not(contains(@class, 'old')) and not(contains(@class, 'new'))]";
    public static final String MESSAGE_DATE_PICKER = "//*[@id='message-date-picker']";
    public static final String MESSAGE_FIELD = "//*[@id='message-field']";
